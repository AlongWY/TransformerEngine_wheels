...
versions = {
    "2.9.0": {"python": [10, 11, 12, 13], "cuda": [126, 128, 130]},
    "2.8.0": {"python": [9, 10, 11, 12, 13], "cuda": [126, 128, 129]},
    "2.7.1": {"python": [9, 10, 11, 12, 13], "cuda": [126, 128]},
    "2.6.0": {"python": [9, 10, 11, 12], "cuda": [124, 126]},
    "2.5.1": {"python": [9, 10, 11, 12], "cuda": [121, 124]},
    "2.4.1": {"python": [8, 9, 10, 11], "cuda": [121, 124]},
    "2.3.1": {"python": [8, 9, 10, 11], "cuda": [121]},
    "2.2.2": {"python": [8, 9, 10, 11], "cuda": [121]},
}
...
cuda_arch = {
    "11.8.0": "6.0;6.1;6.2;7.0;7.5;8.0;8.6;8.9;9.0+PTX",
    "12.1.1": "6.0;6.1;6.2;7.0;7.5;8.0;8.6;8.9;9.0+PTX",
    "12.4.0": "6.0;6.1;6.2;7.0;7.5;8.0;8.6;8.9;9.0+PTX",
    "12.6.0": "6.0;6.1;6.2;7.0;7.5;8.0;8.6;8.9;9.0+PTX",
    "12.8.0": "7.0;7.5;8.0;8.6;9.0;10.0;11.0;12.0+PTX",
    "12.9.0": "7.0;7.5;8.0;8.6;9.0;10.0;11.0;12.0+PTX",
    "13.0.0": "7.5;8.0;8.6;9.0;10.0;11.0;12.0+PTX",
}
